...
<h3>A passionate full-stack developer and UI/UX enthusiast from India. Love to code and built something that helps someone and make their life more easier.</h3>
...
<p align="left" style="display: flex; gap: 10;flex-direction: row">
...
<ul align="left" style="display: flex; gap: 20px;flex-direction: row; flex-wrap: wrap; background: white;"> 
  <li>Core: TypeScript, JavaScript, Node.js, Next.js, React</li>
  <li>Backend & Data: Supabase, PostgreSQL, MySQL, REST APIs</li>
  <li>Tooling & Infra: NPM, CLI tooling, Vercel, DNS, SMTP</li>
  <li>Automation & AI: OpenAI API, n8n, workflow automation</li>
